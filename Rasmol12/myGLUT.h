...
extern void key(unsigned char key, int x, int y);  /* キーボードイベント用コールバック関数 */
extern void myKeyUp(unsigned char key, int x, int y);       /* キーボードイベント用コールバック関数/UP */
extern void mySpecial(int key, int x, int y);     /* キーボードイベント用コールバック関数/特殊キー */
extern void mySpecialUp(int key, int x, int y);   /* キーボードイベント用コールバック関数/特殊キー UP */
...
extern void initializeCamera(PDB *pdb);
